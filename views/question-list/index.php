        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Создать новый опросный лист','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Опросные листы',
                'before'=>'<em></em>',
                ...
                'buttons'=>Html::a('<i class="glyphicon glyphicon-trash"></i>&nbsp; Удалить все',
                    ...
                    [
                        ...
                        'data-confirm-message'=>'Вы уверены, что хотите удалить опрос?'
                    ]).'&nbsp; '.
